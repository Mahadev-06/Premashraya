  ...
  return (
    <footer className="bg-surface-container-low">
      ...
      {!hideCTA && (
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 py-16 md:py-22 text-center">
          ...
          <p className="font-sans text-base md:text-lg text-on-primary-container/80 max-w-2xl mx-auto mb-8">
            Choosing the right path for your loved one is a profound decision. We
            are here to listen, support, and guide you every step of the way.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
          ...
          <div>
            ...
            <p className="font-sans text-sm text-on-surface-variant leading-relaxed">
              A place of dignity and gentle embrace. Providing compassionate
              palliative care in a sanctuary that feels like home.
            </p>
          </div>
